...
const parsetValidaEmail = (name: any): string => {
...
export const isCharacter = (string: string): boolean =>
...
export const onSerializeBodyOrganization = (object: any): OrganizationTDO => {
  ...
  const newOrganization: OrganizationTDO = {
    ...
    email: parsetValidaEmail(object.email),
  };
  return newOrganization;
};
//funcion donde se valida y se arma el DTO de lo que venga en el body de la Organization
export const onSerializeBodyOrganizationTodo = (
  object: any
): InterfaceRegistreTDO => {
